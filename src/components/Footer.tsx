...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-neutral-50 pt-24 pb-12 border-t border-neutral-200">
      {/* Top gradient line */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-neutral-400/30 to-transparent" />
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(0,0,0,0.055),transparent_28%),radial-gradient(circle_at_85%_42%,rgba(34,197,94,0.055),transparent_24%)]" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/registro"
              className="inline-flex items-center gap-2 bg-neutral-900 text-white px-6 py-3 rounded-full font-medium hover:bg-neutral-800 transition-all hover:-translate-y-0.5 active:scale-[0.98] shadow-[0_18px_44px_-28px_rgba(0,0,0,0.5)]"
            >
              Comenzar gratis
            ...
            <Link
              href="/contacto"
              className="inline-flex items-center gap-2 border border-neutral-300 bg-white/70 text-neutral-700 px-6 py-3 rounded-full font-medium hover:bg-white hover:-translate-y-0.5 active:scale-[0.98] transition-all shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]"
            >
              Contactar
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 pb-16 border-b border-neutral-200">
          ...
          <div className="col-span-2 md:col-span-1 flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 mt-2">
              ...
              className="inline-flex items-center gap-2 text-neutral-500 hover:text-neutral-900 text-sm transition-all hover:-translate-y-0.5"
              >
            ...
            <ul className="space-y-3">
              {footerLinks.useCases.links.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="link-underline text-neutral-600 hover:text-neutral-900 text-sm transition-colors"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            ...
            <div className="flex items-center bg-white/86 border border-neutral-200 rounded-full overflow-hidden flex-1 md:flex-none shadow-[0_14px_40px_-30px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.9)] backdrop-blur-xl">
              <input
                type="email"
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-neutral-400 hover:text-neutral-900 transition-all hover:-translate-y-0.5"
